...
root = Tk()
root.title("Data Visualizer using Python : Sahil Sharma")
...
h_name = Label(root, text="Data Visualizer using Python", fg="red", font=('roman', 24, 'bold')).place(relx=0.22, rely=0.01)
m_name = Label(root, text="Sahil Sharma", fg="blue", font=('times', 21, 'underline')).place(relx=0.40, rely=0.07)
